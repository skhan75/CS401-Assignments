...
public class BinarySearchTree<E> extends AbstractSet<E> implements java.io.Serializable
{
     ...
     */
    protected int h(Entry<E> aNode)
    {
        if(aNode == null)
            return -1;

        int leftheight = h(aNode.left);
        int rightheight = h(aNode.right);
    ...
    protected Entry<E> getEntry (Object obj) 
    {
      ...
      *  
      *  @param p ñ the Entry object whose element is to be deleted from this
      *                 BinarySearchTree object.
      *
    ...
    protected class TreeIterator implements Iterator<E>
    {
         ...
         *  objectís next() method.
         *  The worstTime(n) is O(n) and averageTime(n) is constant.
         *
         *  @throws IllegalStateException - if this TreeIteratorís next() method was not
         *                called before this call, or if this TreeIteratorís remove() method was

...
public class CS401StackLinkedListMain {
	...
	//MAIN method for STACK using LINKED LIST Implementation
	public static void main(String[] args){
		
		String array[] ={"a", "b", "c", "d", "e", "f", "g", "h", "i", "j"};
		CS401StackLinkedListImpl<String> task = new CS401StackLinkedListImpl<String>();
		
		System.out.println("Test Vectors for STACK using LINKED LIST Implementation");
		System.out.println("-------------------------------------------------\n");

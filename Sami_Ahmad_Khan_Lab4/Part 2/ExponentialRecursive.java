...
public class ExponentialRecursive {
	...
	*/
	...
	public static void main(String[] args){
		...
		System.out.println("Time elapsed for Recursive Version is: "+timeElapsed/1000000.00+" msec");
	}
	...
	public static long power (long i, int n){
		...
		if(n==1)
			...
			return recPowerCalculator(i,n);
		
				
	}

	private static long recPowerCalculator(long i, int n) {
		
		if (n==0)
			return 1;
		else
			return i*recPowerCalculator(i,n-1);
	}
}
